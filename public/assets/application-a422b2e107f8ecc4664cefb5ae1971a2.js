...
(function() {
  var hideNewBlogModal, showNewBlogModal;
  ...
  $(function() {
    ...
    return $(document).on('click', '#new_blog_modal .close_modal', hideNewBlogModal);
  });
...
(function() {
  var hideInvisibleContent, showInvisibleContent;

  showInvisibleContent = function() {
    $('.invisible_content').show();
    return $('.continue').hide();
  };

  hideInvisibleContent = function() {
  ...
  $(function() {
    ...
    return $(document).on('click', '.collapse', hideInvisibleContent);
  });
